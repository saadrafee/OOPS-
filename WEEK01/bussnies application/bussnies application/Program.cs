...
namespace bussnies_application
{
    class Program
    {
       ...
       static void calulationOfTicketSales(int destinationIdx,int idxForpassangers,int citiesIdx,String[] passangerDestination,string[] cities,int[] eachCitySoldticket)
        ...
        static void signIn(int signidx,string[] username,string[] password,string[] post)
        {
            header();
        ...
        static void admin()
        {
            ...
            while (runing)
            {
                ...
                Console.WriteLine( "press 8 for add new destination " );
        ...
        static void viewticketSales()
        {
            ...
            int y = 24;
            Console.SetCursorPosition(10, y);
            Console.WriteLine("Cities               Soldticket                sales" );
            y++;
            ...
            for (int idx = 0; idx < citiesIdx; idx++)
            {
                y++;
                Console.SetCursorPosition(10, y);
                cout << left << setw(20) << cities[idx] << setw(20)
                     << eachCitySoldticket[idx] << setw(20)
                     << eachCitySoldticket[idx] * rent[idx] << setw(20) << endl;
            }
